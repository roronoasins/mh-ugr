...
print('\n** Dataset: ' + data_file + ', Rest_percent: ' + rest_file + ', Algorithm: ' + algorithm+' **')
...
if algorithm == 'greedy':
    ...
    prueba = LSG(data_file, rest_file, k, seed)
    prueba.local_search()
elif algorithm == 'ag':
    ...
    prueba = ILS(data_file, rest_file, k , seed)
    prueba.ils()
...
if algorithm == 'greedy':
    ...
    print('lambda: '+str(prueba.get_lambda_value()))
    print('Agr: ' +str(prueba.f()   ))
elif algorithm == 'ag' or algorithm == 'am':
    prueba.print_carray()
    prueba.print_solution()
    prueba.print_centroids()
    ...
    prueba.print_solution()
    prueba.print_centroids()
    print('\nGeneral deviation: ' + str(prueba.get_general_deviation_s()))
    print('Infeasibility: ' + str(prueba.get_infeasibility_rl()))
    print('lambda: ' + str(prueba.get_lambda_value()))
    print('Agr: ' + str(prueba.f()))
